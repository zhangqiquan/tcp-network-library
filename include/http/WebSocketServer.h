// +----------------------------------------------------------------------
// | zhanshop / WebSocketServer.h    [ 2022/12/24 上午7:27 ]
// +----------------------------------------------------------------------
...
namespace zhanshop {
    ...
    protected:
        ...
        function<void (TcpConnection* connection, string data)> _webSocketMessageCallback;
    ...
    public:
        WebSocketServer(EventLoop* eventLoop, string ip, int port, unsigned int threadNum);
        ...
        void setMessageCallback(function<void (TcpConnection* connection, string data)> cb);
